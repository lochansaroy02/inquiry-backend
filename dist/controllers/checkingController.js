...
export const createChecking = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = req.body;
    try {
        const { checkingOfficerName, policeStation, captured } = req.body;
...
export const getChecking = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield (prisma === null || prisma === void 0 ? void 0 : prisma.checking.findMany());
